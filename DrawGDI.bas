...
Public Declare Function SetBkMode Lib "gdi32" (ByVal Hdc As Long, ByVal nBkMode As EnumSetBkMode) As Long
Public Declare Function DrawText Lib "user32" Alias "DrawTextA" (ByVal Hdc As Long, ByVal lpStr As String, ByVal nCount As Long, lpRect As Rect, ByVal wFormat As DrawTextFormatFlags) As Long
Public Declare Function DrawEdge Lib "user32" (ByVal Hdc As Long, qrc As Rect, ByVal edge As Long, ByVal grfFlags As Long) As Long
Public Declare Function BitBlt Lib "gdi32" (ByVal hDestDC As Long, ByVal X As Long, ByVal Y As Long, ByVal nWidth As Long, ByVal nHeight As Long, ByVal hSrcDC As Long, ByVal xSrc As Long, ByVal ySrc As Long, Optional ByVal dwRop As RasterOpConstants = vbSrcCopy) As Long
...
Public Declare Function CreatePen Lib "gdi32" (ByVal nPenStyle As EnumPenStyles, ByVal nWidth As Long, ByVal crColor As Long) As Long
Public Declare Function DrawIcon Lib "user32" (ByVal Hdc As Long, ByVal X As Long, ByVal Y As Long, ByVal hIcon As Long) As Long
Public Declare Function DrawIconEx Lib "user32" (ByVal Hdc As Long, ByVal xLeft As Long, ByVal yTop As Long, ByVal hIcon As Long, ByVal cxWidth As Long, ByVal cyWidth As Long, ByVal istepIfAniCur As Long, ByVal hbrFlickerFreeDraw As Long, ByVal diFlags As EDrawIcon) As Long
Public Declare Function OS_DrawFrameControl Lib "user32" (ByVal Hdc As Long, lpRect As Rect, ByVal un1 As Long, ByVal un2 As Long) As Long
Public Declare Function InvertRect Lib "user32" (ByVal Hdc As Long, lpRect As Rect) As Long
Public Declare Function OS2_DeleteDC Lib "gdi32" Alias "DeleteDC" (ByVal Hdc As Long) As Long
Public Declare Function CreateFont Lib "gdi32" Alias "CreateFontA" (ByVal H As Long, ByVal W As Long, ByVal e As Long, ByVal o As Long, ByVal W As Long, ByVal i As Long, ByVal U As Long, ByVal S As Long, ByVal c As Long, ByVal op As Long, ByVal cp As Long, ByVal Q As Long, ByVal PAF As Long, ByVal f As String) As Long
Public Declare Function StretchBlt Lib "gdi32" (ByVal Hdc As Long, ByVal X As Long, ByVal Y As Long, ByVal nWidth As Long, ByVal nHeight As Long, ByVal hSrcDC As Long, ByVal xSrc As Long, ByVal ySrc As Long, ByVal nSrcWidth As Long, ByVal nSrcHeight As Long, Optional ByVal dwRop As RasterOpConstants = vbSrcCopy) As Long
Public Declare Function Ellipse Lib "gdi32" (ByVal Hdc As Long, ByVal X1 As Long, ByVal Y1 As Long, ByVal X2 As Long, ByVal Y2 As Long) As Long
Public Declare Function CreateHatchBrush Lib "gdi32" (ByVal nIndex As EnumHatchStyles, ByVal crColor As Long) As Long
...
Public Function TextWidth(ByVal Hdc As Long, Text As String, Optional wFormats As DrawTextFormatFlags = DT_CALCRECT) As Long
Dim lpRect As Rect
    DrawText Hdc, Text, Len(Text), lpRect, wFormats
...
Dim lpRect As Rect
    ...
    DrawText Hdc, Text, Len(Text), lpRect, DT_CALCRECT Or wFormat
...
Public Function BitBltCopy(ByVal hDestDC As Long, ByVal nWidth As Long, ByVal nHeight As Long, ByVal hSrcDC As Long, Optional ByVal dwRop As RasterOpConstants = vbSrcCopy) As Long
  BitBltCopy = BitBlt(hDestDC, 0, 0, nWidth, nHeight, hSrcDC, 0, 0, dwRop)
End Function

Public Sub LineToEx(ByVal Hdc As Long, ByVal X1 As Long, ByVal Y1 As Long, ByVal X2 As Long, ByVal Y2 As Long)
...
If Hdc = 0 Then Exit Sub
  ...
  Pen = CreatePen(PsSolid, 1, Cor1)
  aPen = SelectObject(Hdc, Pen)
  For Cont = 0 To BorderWidth - 1
    LineToEx Hdc, lpRect.Left + Cont, lpRect.Top + Cont, lpRect.Right - Cont, lpRect.Top + Cont
    LineToEx Hdc, lpRect.Left + Cont, lpRect.Top + Cont, lpRect.Left + Cont, lpRect.Bottom - Cont
  Next
  Pen = SelectObject(Hdc, aPen)
  Call DeleteObject(Pen)
  
  Pen = CreatePen(PsSolid, 1, Cor2)
  aPen = SelectObject(Hdc, Pen)
  For Cont = 0 To BorderWidth - 1
    LineToEx Hdc, lpRect.Left + Cont, lpRect.Bottom - Cont, lpRect.Right - Cont, lpRect.Bottom - Cont
    LineToEx Hdc, lpRect.Right - Cont, lpRect.Top + Cont, lpRect.Right - Cont, lpRect.Bottom
  Next
  Pen = SelectObject(Hdc, aPen)
  Call DeleteObject(Pen)
...
Dim lpPoint As POINTAPI
  ...
  Call LineTo(Hdc, X2, Y1)
  Call MoveToEx(Hdc, X2, Y2, lpPoint)
  Call LineTo(Hdc, X2, Y1)
  Call MoveToEx(Hdc, X2, Y2, lpPoint)
  Call LineTo(Hdc, X1, Y2)
  Call MoveToEx(Hdc, X1, Y2, lpPoint)
  Call LineTo(Hdc, X1, Y1)
End Sub
...
Private Function DrawJustText(ByVal Hdc As Long, ByVal lpStr As String, lpRect As Rect, ByVal wFormat As Long) As Long
  ...
  End If
  DrawJustText = DrawText(Hdc, lpStr, Len(lpStr), lpRect, wFormat)
End Function

Public Function CreateFontEx(ByVal FontName As String, ByVal FontSize As Double, Optional ByVal fdwBold As Boolean, Optional ByVal fdwItalic As Boolean, Optional ByVal fdwUnderline As Boolean, Optional ByVal fdwStrikeOut As Boolean, Optional ByVal nAngle As Long, Optional ByVal fnWeight As Long, Optional ByVal hdcRef As Long) As Long
Dim W As Long, wei As Long
Const OUT_TT_ONLY_PRECIS As Long = 7 ' Output precision constants.
Const CLIP_DEFAULT_PRECIS  As Long = 0 ' Clipping precision constants.
Const CLIP_LH_ANGLES As Long = &H10 ' Character quality constants.
Const PROOF_QUALITY As Long = 2 ' Pitch and family constants.
...
'    LPCTSTR lpszFace  // pointer to typeface name string
  ...
  End If
  CreateFontEx = CreateFont(FontSize, wei, nAngle * 10, 0, W, fdwItalic, fdwUnderline, fdwStrikeOut, 1, OUT_TT_ONLY_PRECIS, CLIP_LH_ANGLES Or CLIP_DEFAULT_PRECIS, PROOF_QUALITY, TRUETYPE_FONTTYPE, FontName & vbNullChar)
End Function
...
Dim lpLogBrush As LOGBRUSH
  ...
  CreateNullBrush = CreateBrushIndirect(lpLogBrush)
End Function
...
Dim HdcTemp As Long, sBitMap As BITMAP
    ...
    If Stretch Then
        ...
        StretchBlt HdcOut, 0, 0, W, H, HdcTemp, 0, 0, sBitMap.bmWidth, sBitMap.bmHeight, vbSrcCopy     'GetDeviceCaps(HdcTemp, 8), GetDeviceCaps(HdcTemp, 10)
    Else
        BitBlt HdcOut, 0, 0, W, H, HdcTemp, 0, 0, vbSrcCopy
    End If
...
Dim HdcTemp As Long, sBitMap As BITMAP
    ...
    If Stretch Then
        GetObject hBitmap, Len(sBitMap), sBitMap
        SetStretchBltMode HdcOut, StretchMode
        StretchBlt HdcOut, X, Y, W, H, HdcTemp, 0, 0, sBitMap.bmWidth, sBitMap.bmHeight, vbSrcCopy     'GetDeviceCaps(HdcTemp, 8), GetDeviceCaps(HdcTemp, 10)
    Else
        BitBlt HdcOut, X, Y, W, H, HdcTemp, 0, 0, vbSrcCopy
    End If
    Call Draw.DeleteDC(HdcTemp)
End Sub
