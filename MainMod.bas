...
Public Const ShowBrushOnHand As Boolean = True
...
'<Initialize StorageMod>'
    ...
    StorageMod.AddBlockToList NonSolid, -1, -1  'Air
    ...
    StorageMod.AddBlockToList FullSolid, -1, -1  'QuestionBlockBeingHit
...
If PlayMode Then
    ...
    UITexture.RenderTo SBuff.Hdc, (SBuff.W - 28) / 2, 16, 28, 28, 224, 0
Else
    If ShowHotBar Then
        ...
        End If
        HotBarTexture.RenderTo SBuff.Hdc, HotBarX, HotBarY, HotBarW, HotBarH, 0, 0
    End If
    ...
    Draw.FillSolidRect SBuff.Hdc, SRect(InvX, InvY, InvW, InvH), HotBarSlotColor
        ...
        End If
    InvBuffer.RenderTo SBuff.Hdc, InvX, InvY, InvW, InvH, 0, 0
    End If
End If
