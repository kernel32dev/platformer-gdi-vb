...
GridTextureBuffer.TransparencyColor = TransColor
MousePointerTexture.TransparencyColor = TransColor
'HotBarTexture.TransparencyColor = TransColor
ParticleTexture.TransparencyColor = TransColor
EntitiesTexture.TransparencyColor = TransColor
UITexture.TransparencyColor = TransColor
MarioTexture.TransparencyColor = TransColor
...
If LenB(BackGroundImages) Then
    ...
    Set BGs(Z).Buffer = New GDIBuffer
        ...
        #Else
            ...
            BGs(Z).Buffer.TransparencyColor = TransColor
            End With
        #End If
